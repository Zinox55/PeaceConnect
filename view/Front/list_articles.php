		...
		<div class="container">
			<div class="row align-items-center">
				<div class="col-lg-6 text-center mx-auto">
					...
					<h1 class="heading text-white mb-2" data-aos="fade-up">Our Articles</h1>
					<p data-aos="fade-up" class=" mb-5 text-white lead text-white-50">Discover our articles on peacebuilding, social cohesion, and inclusion.</p>
				</div>
			</div>
		</div>
	</div>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="causes-item bg-white">
                                <a href="article_detail.php?id=<?php echo $row['id']; ?>">
                                    <?php if($row['image']): ?>
                                        <img src="../../Uploads/<?php echo $row['image']; ?>" alt="Image" class="img-fluid mb-4 rounded" style="width: 100%; height: 250px; object-fit: cover;">
                                    <?php else: ?>
                                        <img src="images/img_v_1-min.jpg" alt="Image" class="img-fluid mb-4 rounded">
                                    <?php endif; ?>
                                </a>
                                <div class="px-4 pb-3 pt-3">
                                    <div class="d-flex justify-content-between mb-3">
                                        <span class="date"><?php echo date('M d, Y', strtotime($row['date_creation'])); ?></span>
                                        <span class="meta">
                                            <span class="icon-heart text-danger"></span> <?php echo $row['like_count']; ?>
                                            <span class="icon-comment text-primary ms-2"></span> <?php echo $row['comment_count']; ?>
                                        </span>
                                    </div>
                                    <h3><a href="article_detail.php?id=<?php echo $row['id']; ?>" class="text-dark"><?php echo $row['titre']; ?></a></h3>
                                    <p><?php echo substr($row['contenu'], 0, 100) . '...'; ?></p>
                                    <p><a href="article_detail.php?id=<?php echo $row['id']; ?>" class="d-flex align-items-center more2"><span>Read More</span> <span class="icon-chevron-right"></span></a></p>
                                </div>
                            </div>
                        </div>
                <?php endwhile; ?>
