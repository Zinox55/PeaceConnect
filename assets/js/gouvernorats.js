// Liste des 24 gouvernorats de Tunisie avec leurs coordonnées GPS
const GOUVERNORATS_TUNISIE = [
    { name: "Ariana", lat: 36.8565, lng: 10.1647 },
    { name: "Béja", lat: 36.7256, lng: 9.1844 },
    { name: "Ben Arous", lat: 36.7592, lng: 10.2372 },
    { name: "Bizerte", lat: 37.2744, lng: 9.8739 },
    { name: "Gabès", lat: 33.8869, lng: 10.0994 },
...
function initGouvernoratAutocomplete(inputId, suggestionsId = null) {
    ...
    input.addEventListener('input', function() {
        ...
        if (filtered.length === 0) {
            suggestionsContainer.innerHTML = '<li class="no-match">Aucun gouvernorat trouvé</li>';
        ...
        filtered.forEach(gov => {
            ...
            li.addEventListener('click', function() {
                ...
                // Déclencher un événement custom pour la validation
...
/**
 * Obtenir les coordonnées GPS d'un gouvernorat
 * @param {string} gouvernoratName - Nom du gouvernorat
 * @returns {object|null} Objet {lat, lng} ou null si non trouvé
 */
 ...
 * @param {string} gouvernoratName - Nom à vérifier
 * @returns {boolean}
 */
